...
class test_19181(GaiaTestCase):
    ...
    def test_run(self):
        ...
        self.check_Field(True , "phone"    , "number")
        self.check_Field(True , "email"    , "email")
        self.check_Field(True , "address"  , "streetAddress")
        self.check_Field(True , "comment"  , "note")
        ...
        self.check_Field(False, "photo")

    def check_Field(self, p_text, p_fieldName, p_resetBtnName=""):
        #
